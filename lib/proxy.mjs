...
/**
 * issue #58：DSH 客户端用 location.hostname 判定 connection.isLoopback；手机/局域网
 ...
 */
export const DEFAULT_INJECT = RANDOM_UUID_POLYFILL + TRANSPORT_API_CLIENT_SHIM + LOOPBACK_ENV_PATCH;
